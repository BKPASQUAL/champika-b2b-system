...
export const generateQuotationHTML = async (
  ...
  const qrDataUrl = quotationUrl
    ? await QRCode.toDataURL(quotationUrl, { width: 80, margin: 1 })
    : "";
  ...
  <div class="invoice-page" style="page-break-after:always;width:100%;min-height:277mm;padding:8px 20px 20px;background:#fff;font-family:${FONT_STACK};color:#111;box-sizing:border-box;display:flex;flex-direction:column;">
          ...
          <table style="margin-left:auto;border-collapse:collapse;">
            <tr>
              ...
              <td style="vertical-align:top;text-align:right;">
                <div style="font-size:13px;font-weight:700;color:#555;letter-spacing:0.5px;text-transform:uppercase;">QUOTATION</div>
                <div style="font-size:18px;font-weight:700;color:#000;letter-spacing:0.5px;margin-top:2px;">${quotationNoDisplay}</div>
                <div style="font-size:11px;color:#333;margin-top:2px;line-height:1.5;">
                  ${formatDate(quotation.date || quotation.createdAt)}<br>${salesRep}
                </div>
              </td>
            </tr>
          </table>
    ...
    <div style="margin-bottom:12px;">
      <div style="font-size:11px;color:#666;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:2px;">Quotation For:</div>
    ...
    <table style="width:100%;border-collapse:collapse;margin-bottom:10px;">
      <tr>
        <td style="width:55%;">
          ${notes ? `<div style="font-size:11px;color:#555;line-height:1.5;"><strong>Notes:</strong><br>${notes}</div>` : ""}
        </td>
    ...
    <table style="width:100%;border-collapse:collapse;margin-top:40px;margin-bottom:8px;">
      <tr>
        ...
        <td style="width:45%;text-align:center;padding-top:6px;border-top:1.5px solid #555;">
          <div style="font-size:11px;color:#333;font-weight:600;margin-top:3px;">Authorised Signature</div>
        </td>
      </tr>
    </table>` : `
...
// A5 / Half-page view wrapper for carbon-paper printing
...
<div class="half-invoice" style="width:100%;height:138mm;padding:10px 22px 8px 14px;background:#fff;font-family:${FONT_STACK};color:#111;box-sizing:border-box;display:flex;flex-direction:column;overflow:hidden;">
      ...
      <td style="vertical-align:top;text-align:right;width:38%;">
        <table style="margin-left:auto;border-collapse:collapse;">
          <tr>
            ...
            <td style="vertical-align:top;text-align:right;">
              <div style="font-size:10px;font-weight:700;color:#555;letter-spacing:0.5px;text-transform:uppercase;">QUOTATION</div>
              <div style="font-size:14px;font-weight:700;color:#000;letter-spacing:0.5px;">${quotationNoDisplay}</div>
  ...
  <div style="margin-bottom:6px;">
    <div style="font-size:10px;color:#666;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:1px;">Quotation For:</div>
  ...
  <table style="width:100%;border-collapse:collapse;margin-top:4px;margin-bottom:4px;">
    <tr>
      <td style="width:55%;">
        ${notes ? `<div style="font-size:9px;color:#555;line-height:1.5;"><strong>Notes:</strong><br>${notes}</div>` : ""}
      </td>
  ...
  <table style="width:100%;border-collapse:collapse;margin-top:16px;margin-bottom:4px;">
    <tr>
      ...
      <td style="width:45%;text-align:center;padding-top:5px;border-top:1.5px solid #555;">
        <div style="font-size:10px;color:#333;font-weight:600;margin-top:2px;">Authorised Signature</div>
      </td>
    </tr>
  </table>` : `
