...
export const generateInvoiceHTML = async (
  ...
  return `
  <div class="invoice-page" style="page-break-after:always;width:100%;min-height:277mm;padding:16px 6px 20px;background:#fff;font-family:${FONT_STACK};color:#111;box-sizing:border-box;display:flex;flex-direction:column;">
    ...
    <style>
      * { box-sizing: border-box; }
      ...
      @media print {
        ...
        .invoice-page { page-break-after: always; width: 210mm !important; padding: 4mm 1.5mm !important; }
