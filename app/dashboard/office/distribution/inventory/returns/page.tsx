...
export default function ReturnsPage() {
  ...
  useEffect(() => {
    fetchData();
  }, [page, startDate, endDate]); // Removed searchQuery from here to avoid debounce issues, handled via enter/button or manual effect if needed
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 ml-10">
            View history and process new customer returns for Champika Distribution.
          </p>
        </div>
