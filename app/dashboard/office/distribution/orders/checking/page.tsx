                ...
                return (
                  <div
                    ...
                    className={`bg-white border rounded-xl p-4 shadow-sm flex flex-col gap-3 transition-all duration-200 ${
                      isSelected
                        ? "border-purple-400 ring-1 ring-purple-400 bg-purple-50/10"
                        : "border-slate-200"
                    }`}
                  >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div
                          ...
                          onClick={() => {
                            ...
                            router.push(`/dashboard/office/distribution/orders/checking/${order.id}`);
                          }}
                        >
                    ...
                    {locked ? (
                      ...
                      <Button
                        ...
                        onClick={() => router.push(`/dashboard/office/distribution/orders/checking/${order.id}`)}
                      >
                ...
                {filteredOrders.length === 0 ? (
                  ...
                  filteredOrders.map((order) => {
                    ...
                    return (
                      <TableRow
                        key={order.id}
                        className={`hover:bg-slate-50 ${isSelected ? "bg-purple-50/30" : ""}`}
                      >
