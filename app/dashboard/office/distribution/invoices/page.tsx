// app/dashboard/office/distribution/invoices/page.tsx
"use client";
...
export default function DistributionInvoicesPage() {
  ...
  const fetchInvoices = useCallback(async () => {
    try {
      setLoading(true);
      // Locked to Distribution Business
  ...
  const handleEdit = (id: string) => {
    router.push(`/dashboard/office/distribution/invoices/${id}/edit`);
  };

  const handleView = (id: string) => {
    router.push(`/dashboard/office/distribution/invoices/${id}`);
  };
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage distribution bills, track payments, and view order status.
          </p>
        </div>
