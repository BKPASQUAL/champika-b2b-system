// app/dashboard/office/distribution/invoices/_components/InvoiceTable.tsx
import {
  Table,
  TableBody,
  TableCell,
...
// Import print utility from admin folder to reuse code
import { printInvoice } from "@/app/dashboard/admin/invoices/print-utils";
