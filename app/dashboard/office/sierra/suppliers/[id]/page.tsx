...
export default function WiremanSupplierDetailsPage() {
  ...
  const fetchSupplierDetails = async () => {
    try {
      setLoading(true);
      // ✅ Added businessId to filter stats/purchases/payments for Wireman
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* ✅ Updated Navigation Link for Wireman */}
        <Button
          variant="outline"
          className="text-red-600 border-red-200 hover:bg-red-50"
          onClick={() =>
            router.push(
              `/dashboard/office/wireman/suppliers/${supplierId}/damage`,
            )
          }
        >
