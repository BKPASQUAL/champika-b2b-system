...
export default function SierraInvoicesPage() {
  ...
  const handleView = (id: string) => {
    router.push(`/dashboard/office/sierra/invoices/${id}`);
  };
  ...
  const handleExportOutstandingPdf = () => {
    try {
      ...
      // Title
      doc.setFontSize(18);
      doc.text("Sierra Distribution", 14, 20);
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage Sierra bills, track payments, and view status.
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Button
            onClick={() =>
              router.push("/dashboard/office/sierra/invoices/create")
            }
