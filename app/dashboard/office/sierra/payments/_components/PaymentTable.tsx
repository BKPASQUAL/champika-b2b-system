        ...
        <Table>
          <TableHeader className="bg-purple-50/50">
            <TableRow>
              ...
              <TableHead className="text-purple-900">Reference</TableHead>
              <TableHead
                className="cursor-pointer hover:bg-purple-100/50"
              ...
              <TableHead
                className="text-right cursor-pointer hover:bg-purple-100/50"
                onClick={() => onSort("amount")}
              >
                <div className="flex items-center justify-end text-purple-900">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          onClick={() =>
                            window.open(
                              `/dashboard/office/sierra/invoices/${payment.invoiceId}`,
                              "_blank"
                            )
                          }
                        >
