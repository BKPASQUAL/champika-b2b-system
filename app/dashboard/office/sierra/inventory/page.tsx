...
export default function SierraInventoryPage() {
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text("Sierra Agency - Inventory Report", 14, 15);
    doc.setFontSize(10);
    ...
    autoTable(doc, {
      ...
      startY: 30,
      styles: { fontSize: 8 },
      headStyles: { fillColor: [220, 38, 38] }, // Red Header Color
    });
    doc.save(`Sierra_Inventory_${date}.pdf`);
  };
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(
      wb,
      `Sierra_Inventory_${new Date().toLocaleDateString()}.xlsx`,
    );
  };
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-red-950">
            Stock Control (Sierra)
          </h1>
          <p className="text-muted-foreground mt-1">
            Monitor inventory levels, returns, and damages for Sierra Agency.
          </p>
        </div>
        <div className="flex gap-2 flex-wrap">
          ...
          <Button
            ...
            onClick={() =>
              router.push("/dashboard/office/sierra/inventory/transfer")
            }
          >
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="border-l-4 border-l-green-500 shadow-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Sierra Stock Value</p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Store className="w-5 h-5 text-red-600" /> Location Overview
          </CardTitle>
          <CardDescription>
                    ...
                    <TableRow
                      ...
                      onClick={() => {
                        if (loc.isDamageLocation || loc.id === "damage-location") {
                          ...
                          router.push(
                            `/dashboard/office/sierra/inventory/${loc.id}`,
                          );
                        }
                      }}
                    >
                        ...
                        {loc.isDamageLocation ? (
                          ...
                          <div className="flex justify-end gap-1.5">
                            <Button
                              ...
                              onClick={() =>
                                router.push(`/dashboard/office/sierra/inventory/${loc.id}/adjust`)
                              }
                            >
                              Adjust
                            </Button>
                            <Button
                              ...
                              onClick={() =>
                                router.push(`/dashboard/office/sierra/inventory/${loc.id}`)
                              }
                            >
                              View
                            </Button>
      ...
      <Card>
        <CardHeader>
          <div className="flex flex-col md:flex-row justify-between gap-4 items-center">
            <div>
              <CardTitle className="flex items-center gap-2">
                <Layers className="w-5 h-5 text-red-600" /> Master Inventory
              </CardTitle>
              <CardDescription>
                Detailed stock levels (Sierra Agency).
              </CardDescription>
            </div>
