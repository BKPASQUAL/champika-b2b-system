      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="md:col-span-1 h-fit border-purple-100">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-3 bg-purple-50/50 rounded-lg border border-purple-100 text-center space-y-1">
              <span className="text-xs text-purple-600/70 uppercase tracking-wide">
              ...
              {selectedProduct && ((selectedProduct.mrp ?? 0) > 0 || (selectedProduct.sellingPrice ?? 0) > 0) && (
                <div className="flex items-center justify-center gap-4 pt-1 border-t mt-1">
                  {(selectedProduct.mrp ?? 0) > 0 && (
                    <span className="text-xs text-purple-600/70">
                      MRP: <span className="font-semibold text-purple-900">Rs {selectedProduct.mrp?.toLocaleString()}</span>
                    </span>
                  )}
                  {(selectedProduct.sellingPrice ?? 0) > 0 && (
                    <span className="text-xs text-purple-600/70">
                      Price: <span className="font-semibold text-purple-700">Rs {selectedProduct.sellingPrice?.toLocaleString()}</span>
                    </span>
                  )}
                </div>
              )}
