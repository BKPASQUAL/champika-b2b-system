...
export default function RetailDamageHistoryPage() {
  ...
  const { data: damages = [], loading } = useCachedFetch<any[]>(
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 ml-8">
            History of internal stock damages for Champika Retail.
          </p>
        </div>
        <Button
                    ...
                    <TableRow key={item.id}>
                      ...
                      <TableCell>
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs text-muted-foreground">{item.products?.sku}</span>
                        </div>
                      </TableCell>
                      <TableCell>
