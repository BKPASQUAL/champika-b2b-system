...
export default function RetailViewInvoicePage({
  ...
  const handleSharePdf = async () => {
    ...
    try {
      const { blob, filename } = await generateInvoicePdfBlob(id, "retail");
      toast.dismiss(tid);
                ...
                <Table>
                  ...
                  <TableFooter className="bg-slate-50/50">
                    <TableRow>
                      ...
                      <TableCell
                        colSpan={3} // Increased colspan for discount column
