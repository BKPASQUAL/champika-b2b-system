...
export default function WiremanSuppliersPage() {
  ...
  const generateExcel = () => {
    ...
    XLSX.writeFile(
      wb,
      `Wireman_Suppliers_${new Date().toISOString().split("T")[0]}.xlsx`,
    );
  };
  ...
  const generatePDF = () => {
    ...
    const doc = new jsPDF();
    doc.text("Wireman Suppliers Report", 14, 15);
    autoTable(doc, {
    ...
    doc.save(`Wireman_Suppliers_${new Date().toISOString().split("T")[0]}.pdf`);
  };
          ...
          <SupplierTable
            ...
            onEdit={(s) => {
              setFormData({
                ...
                businessId: s.businessId || BUSINESS_IDS.WIREMAN_AGENCY,
              });
