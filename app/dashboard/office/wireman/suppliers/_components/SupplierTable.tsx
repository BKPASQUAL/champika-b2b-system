            ...
            {suppliers.length === 0 ? (
              ...
              suppliers.map((supplier) => (
                <TableRow
                  ...
                  onClick={() =>
                    router.push(
                      `/dashboard/office/wireman/suppliers/${supplier.id}`,
                    )
                  }
                >
                  ...
                  <TableCell className="text-right">
                    ...
                    >
                      ...
                      {/* Usually Office users don't delete, but enabled per "Same as Admin" request */}
                      <Button
                        variant="ghost"
                        size="icon"
