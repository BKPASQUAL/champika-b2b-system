  ...
  return (
    <>
      ...
      <div className="lg:hidden">
        {products.length === 0 ? (
          <div className="text-center py-12 text-muted-foreground">No Wireman products found</div>
        ) : (
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      <Button variant="ghost" size="icon" className="h-8 w-8 text-slate-500 hover:text-red-600 hover:bg-red-50"
                        onClick={() => router.push(`/dashboard/office/wireman/products/${product.id}`)}>
      ...
      {!loading && products.length > 0 && (() => {
        ...
        return (
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between px-4 py-3 border-t bg-slate-50/30">
