...
export default function WiremanInventoryPage() {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      // Fetch specifically for WIREMAN AGENCY
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text("Wireman Agency - Inventory Report", 14, 15);
    doc.setFontSize(10);
    ...
    doc.save(`Wireman_Inventory_${date}.pdf`);
  };
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(
      wb,
      `Wireman_Inventory_${new Date().toLocaleDateString()}.xlsx`,
    );
  };
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-red-950">
            Stock Control (Wireman)
          </h1>
          <p className="text-muted-foreground mt-1">
            Monitor inventory levels, returns, and damages for Wireman Agency.
          </p>
        </div>
        <div className="flex gap-2 flex-wrap">
          ...
          <Button
            ...
            onClick={() =>
              router.push("/dashboard/office/wireman/inventory/transfer")
            }
          >
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="border-l-4 border-l-green-500 shadow-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Wireman Stock Value</p>
          </CardContent>
        </Card>
        ...
        <CardHeader>
          <div className="flex flex-col md:flex-row justify-between gap-4 items-center">
            <div>
              ...
              <CardDescription>
                Detailed stock levels (Wireman Agency).
              </CardDescription>
            </div>
