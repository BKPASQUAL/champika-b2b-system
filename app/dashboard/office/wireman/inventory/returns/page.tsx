...
export default function WiremanReturnsPage() {
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-red-950">
              Returns Management (Wireman)
            </h1>
          </div>
          <p className="text-muted-foreground mt-1 ml-10">
            View history and process new customer returns for Wireman Agency.
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Button
            ...
            onClick={() =>
              router.push("/dashboard/office/wireman/inventory/returns/create")
            }
          >
