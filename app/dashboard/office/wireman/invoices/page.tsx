...
const STORAGE_KEYS = {
  search: "wireman_invoices_search",
  status: "wireman_invoices_status",
  rep: "wireman_invoices_rep",
  sortField: "wireman_invoices_sortField",
  sortOrder: "wireman_invoices_sortOrder",
  page: "wireman_invoices_page",
};
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage Wireman bills, track payments, and view status.
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Button
            variant="outline"
            onClick={() =>
              router.push("/dashboard/office/wireman/invoices/search-invoice")
            }
          >
          ...
          <Button
            onClick={() =>
              router.push("/dashboard/office/wireman/invoices/create")
            }
