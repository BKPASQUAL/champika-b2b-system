// app/dashboard/office/orange/suppliers/payments/page.tsx
"use client";
                ...
                <TableBody>
                  {filteredPurchases.map((p) => (
                    ...
                    >
                      ...
                      <TableCell>
                        <button
                          className="font-mono text-xs bg-orange-50 text-orange-700 border border-orange-100 px-2 py-0.5 rounded hover:bg-orange-100 transition-colors"
                          onClick={() => router.push(`/dashboard/office/orange/purchases/${p.id}`)}
                        >
                          {p.purchaseId}
                        </button>
                      </TableCell>
                        ...
                        {group.isMultiple ? (
                          <div className="flex flex-wrap gap-1 max-w-[200px]">
                            {group.purchaseIds.map((id, idx) => (
                              <span key={idx} className="font-mono text-[10px] bg-orange-50 text-orange-700 border border-orange-100 px-1.5 py-0.5 rounded">
                                {id}
                              </span>
                            ))}
                          </div>
                        ) : (
                          <span className="font-mono text-xs bg-orange-50 text-orange-700 border border-orange-100 px-2 py-0.5 rounded">
                            {group.purchaseIds[0] ?? "-"}
                          </span>
                        )}
                      </TableCell>
                            ...
                            {group.isMultiple ? (
                              ...
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  if (singlePurchaseId) {
                                    router.push(`/dashboard/office/orange/purchases/${singlePurchaseId}`);
                                  }
                                }}
                              >
                                {group.purchaseIds[0] ?? "-"}
