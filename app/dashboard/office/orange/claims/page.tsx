...
export default function OrangeFreeIssueClaimsPage() {
  const router = useRouter();
  const { data: items = [], loading } = useCachedFetch<any[]>(
    "/api/orange/claims/free-issues",
    [],
  ...
  const handleConvertSelected = () => {
    ...
    router.push(
      `/dashboard/office/orange/purchases/create-free?ids=${queryString}`,
    );
  };

  const handleCreateManual = () => {
    router.push(`/dashboard/office/orange/purchases/create-free`);
  };
