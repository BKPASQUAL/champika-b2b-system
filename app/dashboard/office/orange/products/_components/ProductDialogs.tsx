          ...
          <div className="grid grid-cols-2 gap-4 py-4">
            ...
            <div className="col-span-2 space-y-3 pt-4 border-t mt-2">
              ...
              <div className="grid grid-cols-6 gap-3">
                {showUpload && (
                  <div
                    className="aspect-square rounded-lg border-2 border-dashed flex flex-col items-center justify-center cursor-pointer hover:bg-orange-50 transition-all"
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This will permanently remove this item from the Orange catalog.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
