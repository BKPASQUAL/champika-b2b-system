...
export default function OrangeStockTransferPage() {
  ...
  const fetchLocations = async () => {
    try {
      // Pass businessId for ORANGE AGENCY
  ...
  const fetchSourceStock = async () => {
    ...
    try {
      ...
      // Filter out items with 0 stock for the selected type
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      router.push("/dashboard/office/orange/inventory");
    } catch (error: any) {
      toast.error(error.message);
    } finally {
      setSubmitting(false);
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-orange-950">
              Stock Transfer (Orange)
            </h1>
          </div>
          <p className="text-muted-foreground mt-1 ml-8">
            Move inventory between Orange Agency locations.
          </p>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base">
                <MapPin className="w-4 h-4 text-orange-600" /> Transfer Details
              </CardTitle>
            </CardHeader>
          ...
          <Card className={!sourceId ? "opacity-60 pointer-events-none" : ""}>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base">
                <Package className="w-4 h-4 text-orange-600" /> Select Products
              </CardTitle>
            </CardHeader>
            <CardContent>
              {stockLoading ? (
          ...
          <Card className="h-full flex flex-col">
            <CardHeader className="border-b pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="flex items-center gap-2 text-base">
                  <ClipboardList className="w-4 h-4 text-orange-600" /> Transfer
                  List
                </CardTitle>
