...
export default function OrangeDamageHistoryPage() {
  ...
  const handleExportPDF = () => {
    ...
    doc.save(`Orange_Damage_Report_${date}.pdf`);
  };
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(wb, `Orange_Damage_Report_${new Date().toLocaleDateString()}.xlsx`);
  };
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-orange-950">
              Damage Reports (Orange)
            </h1>
          </div>
          <p className="text-muted-foreground mt-1 ml-8">
            History and stock value of internal damages for Orange Agency.
          </p>
        </div>
        <div className="flex gap-2 flex-wrap">
          ...
          <Button
            ...
            onClick={() =>
              router.push("/dashboard/office/orange/inventory/damage/adjust")
            }
          >
          ...
          <Button
            ...
            onClick={() =>
              router.push("/dashboard/office/orange/inventory/damage/create")
            }
          >
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p>No damage reports found for Orange Agency.</p>
            </div>
          ) : (
            <>
