...
export default function OrangeDamageAdjustmentPage() {
  ...
  useEffect(() => {
    const fetchLocations = async () => {
      try {
        setLoading(true);
        const res = await fetch(`/api/settings/locations?businessId=${BUSINESS_IDS.ORANGE_AGENCY}`);
    ...
    const fetchStocks = async () => {
      try {
        ...
        const [productsRes, stockRes] = await Promise.all([
          ...
          fetch(`/api/inventory/${selectedLocationId}?businessId=${BUSINESS_IDS.ORANGE_AGENCY}&includeAll=true`),
        ]);
        ...
        <div>
          <div className="flex items-center gap-2">
            <Button
              ...
              onClick={() => router.push("/dashboard/office/orange/inventory/damage")}
            >
            ...
            <h1 className="text-3xl font-bold tracking-tight text-orange-950 flex items-center gap-2">
              ...
              Adjust Damaged Stock (Orange)
            </h1>
          </div>
          <p className="text-muted-foreground mt-1 ml-8">
            Perform physical audit, write-offs, and count corrections for damaged items.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="text-sm font-medium flex items-center gap-1.5 text-slate-700">
                <MapPin className="w-4 h-4 text-orange-600" /> Target Location
              </label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium flex items-center gap-1.5 text-slate-700">
                <Layers className="w-4 h-4 text-orange-600" /> Batch Adjustment Reason
              </label>
              <Input
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="md:col-span-1 h-fit">
          <CardHeader>
            ...
            <CardDescription>Select product (Orange Only) and enter count.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {stockLoading ? (
              ...
              <>
                ...
                {/* Product Snapshot */}
                <div className="rounded-lg border bg-orange-50/40 p-3 flex gap-3 items-start">
                  <div className="shrink-0">
                    {selectedProduct?.images?.[0] ? (
                      <img
                        src={selectedProduct.images[0]}
                        alt={selectedProduct?.name}
                        className="w-16 h-16 rounded-lg object-cover border border-orange-200 shadow-sm"
                      />
                    ) : (
                      <div className="w-16 h-16 rounded-lg border border-orange-200 bg-white flex items-center justify-center">
                ...
                <div className="flex rounded-md border overflow-hidden text-xs font-semibold">
                  <button
                    ...
                    className={cn(
                      ...
                      addMode === "set" ? "bg-orange-600 text-white" : "bg-muted text-muted-foreground hover:bg-muted/70"
                    )}
                  ...
                  <button
                    ...
                    className={cn(
                      "flex-1 py-2 transition-colors",
                      addMode === "add" ? "bg-orange-600 text-white" : "bg-muted text-muted-foreground hover:bg-muted/70"
                    )}
                  ...
                  <button
                    ...
                    className={cn(
                      "flex-1 py-2 transition-colors",
                      addMode === "subtract" ? "bg-orange-600 text-white" : "bg-muted text-muted-foreground hover:bg-muted/70"
                    )}
        ...
        <Card className="md:col-span-2">
          ...
          <CardContent>
            {pendingAdjustments.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-muted-foreground border-2 border-dashed rounded-lg bg-orange-50/20">
                <AlertCircle className="w-10 h-10 mb-2 opacity-30 text-orange-500" />
      ...
      <Dialog open={editDialog.open} onOpenChange={(open) => setEditDialog((d) => ({ ...d, open }))}>
        <DialogContent className="sm:max-w-sm">
          ...
          <DialogFooter className="gap-2 sm:gap-0">
            ...
            <Button className="bg-orange-600 hover:bg-orange-700 text-white" onClick={handleEditSave}>
              Save
            </Button>
          </DialogFooter>
        </DialogContent>
