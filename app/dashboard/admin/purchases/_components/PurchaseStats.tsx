...
export function PurchaseStats({ purchases }: PurchaseStatsProps) {
  // Fix: Use state to ensure Intl formatting only happens on the client
  ...
  // Safely calculate totals ensuring values are numbers
  ...
  const formatCompact = (amount: number) => {
    // Prevent mismatch by not running Intl on the server
